...
@admin.route('/admin_managetime',methods=['post','get'])
def admin_managetime():
	data={}
	q="select * from time"
	res=select(q)
	data['subview']=res
	...
	if action=='active':
		...
		update(q)
		flash('successfully')
		return redirect(url_for('admin.admin_managetime'))
	...
	return render_template('admin_managetime.html',data=data)



@admin.route('/admin_managelocation',methods=['post','get'])
def admin_managelocation():
	data={}
	...
	if action=='active':
		...
		update(q)
		flash('successfully')
		return redirect(url_for('admin.admin_managelocation'))
	...
	return render_template('admin_managelocation.html',data=data)
